 ...
 * 
 * Copy class from https://github.com/dzheng533/GitHubTestProject/blob/master/src/com/cyberdis/QuotedPrintable.java
 * 
 */
            ...
            if (qp[i] == '=') {
                if (qplen - i > 2) {
                    ...
                    if (qp[i+1] == CR && qp[i+2] == LF) {
                        ...
                        //Log.e("DEBUG", "decode: Invalid sequence = " + qp[i+1] + qp[i+2]);
                    }
                }
